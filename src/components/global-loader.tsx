...
export function GlobalLoader() {
  ...
  return (
    ...
    >
      <div className="rounded-xl border bg-card px-8 py-7 text-card-foreground shadow-lg animate-in fade-in-0 zoom-in-95 duration-150">
        <NucleusLoader size={48} message={message} className="gap-3" />
      </div>
    </div>
  )
}
