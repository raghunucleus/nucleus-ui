...
export const hi: typeof en = {
  ...
  devices: {
    limitTitle: 'डिवाइस सीमा पूरी हो गई',
    limitDesc_one:
      'आप {{count}} अनुमत डिवाइस में से {{n}} पर साइन इन हैं। यहाँ जारी रखने के लिए कम से कम एक से साइन आउट करें।',
    limitDesc_other:
      'आप {{count}} अनुमत डिवाइस में से {{n}} पर साइन इन हैं। यहाँ जारी रखने के लिए कम से कम एक से साइन आउट करें।',
    lastActive: 'अंतिम बार सक्रिय: {{when}}',
    signedIn: 'साइन इन: {{when}}',
    submit_one: '{{count}} डिवाइस से साइन आउट करें और जारी रखें',
    submit_other: '{{count}} डिवाइस से साइन आउट करें और जारी रखें',
    selectPrompt: 'साइन आउट करने के लिए डिवाइस चुनें',
    raceNotice:
      'वे डिवाइस साइन आउट हो गए, लेकिन सभी स्लॉट फिर से भर गए हैं — कोई दूसरा डिवाइस चुनें।',
    challengeExpired: 'आपका साइन-इन सत्र समाप्त हो गया है। कृपया फिर से साइन इन करें।',
    title: 'साइन-इन किए गए डिवाइस',
    subtitle:
      'वे सभी जगहें जहाँ आपका खाता साइन इन है। जिस डिवाइस को आप नहीं पहचानते, उससे साइन आउट करें — यह तुरंत लागू होता है।',
    thisDevice: 'यह डिवाइस',
    empty: 'कोई साइन-इन किया गया डिवाइस नहीं मिला।',
    loadError: 'आपके डिवाइस लोड नहीं हो सके।',
    confirmTitleCurrent: 'इस डिवाइस से साइन आउट करें?',
    confirmTitleOther: '“{{name}}” से साइन आउट करें?',
    confirmDescCurrent: 'आपको साइन-इन स्क्रीन पर वापस ले जाया जाएगा।',
    confirmDescOther:
      'वह डिवाइस तुरंत डिस्कनेक्ट हो जाएगा और उसे फिर से साइन इन करना होगा।',
    signedOutToast: '“{{name}}” से साइन आउट हो गया।',
    alreadySignedOut: 'वह डिवाइस पहले ही साइन आउट हो चुका था।',
    revokeError: 'उस डिवाइस से साइन आउट नहीं हो सका। कृपया पुनः प्रयास करें।',
  },
}
